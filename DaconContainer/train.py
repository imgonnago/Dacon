...
def predict(pivot_df_value, pivot_df_weight, pairs, reg, x_scaler, y_scaler, item_to_hs4_map):
    ...
    for row in tqdm(pairs.itertuples(index=False)):
        ...
        X_test_df['leading_hs4'] = X_test_df['leading_hs4'].astype('category')
        X_test_df['following_hs4'] = X_test_df['following_hs4'].astype('category')
